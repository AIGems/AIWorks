...
function myfunction() {
	window.open(
		'/timeline.html','popUpWindow','height=800,width=600,left=50%,top=50%,resizable=yes,scrollbars=yes,toolbar=yes,menubar=no,location=no,directories=no,status=yes')
}